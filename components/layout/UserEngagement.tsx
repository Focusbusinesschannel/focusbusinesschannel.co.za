        ...
        <>
                ...
                {showExitPopup && (
                    <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 bg-black/60 backdrop-blur-sm">
                        <motion.div
                            ...
                            className="bg-surface border border-white/10 p-8 md:p-12 rounded-3xl max-w-lg w-full relative overflow-hidden shadow-2xl"
                        >
                            <div className="absolute top-0 right-0 p-4">
                                <button onClick={() => setShowExitPopup(false)} className="text-gray-500 hover:text-white transition-colors">
                                    <X size={24} />
                                </button>
                            </div>
                            ...
                            <AnimatePresence mode="wait">
                                {!isExitFormOpen ? (
                                    ...
                                    >
                                        ...
                                        <h2 className="text-3xl font-display font-bold text-white mb-4">Don't Miss Out!</h2>
                                        ...
                                        <div className="flex flex-col gap-4">
                                            <button
                                                ...
                                                className="w-full py-4 bg-white text-black font-bold rounded-xl hover:bg-accent hover:text-white transition-all"
                                            >
                                                Download Guide
                                            </button>
                                            <button onClick={() => setShowExitPopup(false)} className="text-gray-500 text-sm hover:text-white underline transition-colors">
                                                Maybe later
                                            </button>
                                        </div>
                                    </motion.div>
                                    ...
                                    >
                                        ...
                                        <h2 className="text-2xl font-display font-bold text-white">Unlock the Guide</h2>
                ...
                {showNewsletter && (
                    <div className="fixed bottom-8 left-8 z-[100] max-w-sm w-full">
                        <motion.div
                            ...
                            animate={{ opacity: 1, x: 0 }}
                            exit={{ opacity: 0, x: -50 }}
                            className="bg-surface border border-white/10 p-6 rounded-2xl shadow-2xl relative"
                        >
                            ...
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <h3 className="text-lg font-display font-bold text-white">Focus Newsletter</h3>
                            </div>
                            ...
                            <form className="flex gap-2" onSubmit={(e) => { e.preventDefault(); setShowNewsletter(false); }}>
                                <input
                                    ...
                                    className="flex-1 bg-white/5 border border-white/10 rounded-lg px-3 py-2 text-sm text-white focus:border-accent outline-none"
                                    required
                                />
                                <button type="submit" className="bg-white text-black p-2 rounded-lg hover:bg-accent hover:text-white transition-all">
                                    <Send size={18} />
                                </button>
                            </form>
                        </motion.div>
            ...
            <div className="fixed bottom-8 right-8 z-[100]">
                <AnimatePresence>
                    {isChatOpen && (
                        <motion.div
                            ...
                            animate={{ opacity: 1, scale: 1, y: 0 }}
                            exit={{ opacity: 0, scale: 0.9, y: 20 }}
                            className="bg-surface border border-white/10 w-80 md:w-96 rounded-2xl shadow-2xl mb-4 overflow-hidden"
                        >
                            {/* Chat Header */}
                            ...
                            <div className="p-6 h-64 overflow-y-auto bg-background/50 space-y-4">
                                <div className="bg-white/5 border border-white/10 p-3 rounded-tr-xl rounded-b-xl max-w-[80%]">
                            ...
                            <div className="p-4 border-t border-white/5 bg-surface">
                                <form className="flex gap-2" onSubmit={(e) => e.preventDefault()}>
                                    <input
                                        ...
                                        className="flex-1 bg-white/5 border border-white/10 rounded-lg px-4 py-2 text-sm text-white focus:border-accent outline-none"
                                    />
                                    <button type="submit" className="p-2 text-accent hover:text-white transition-colors">
                                        <Send size={20} />
                                    </button>
                                </form>
                            </div>
                ...
                <button
                    ...
                    className="w-14 h-14 bg-white text-black rounded-full shadow-2xl flex items-center justify-center hover:bg-accent hover:text-white transition-all hover:scale-110 active:scale-95"
